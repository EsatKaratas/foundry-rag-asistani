...
TEST_CASES = [
    ...
    ("Zirh ne ise yarar?", True, "zirh_ve_hasar.txt"),
    ("Sessiz yurumenin bedeli nedir?", True, "ses_ve_dinleme.txt"),
    ("Capraz ates nedir?", True, "konumlanma_ve_aci.txt"),
    ("Cok fazla duelist secmek neden sorun olur?", True, "takim_kompozisyonu.txt"),
    ("Tek basina ilerlemek neden hatali?", True, "sik_yapilan_hatalar.txt"),
