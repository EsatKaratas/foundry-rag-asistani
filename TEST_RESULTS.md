# Test Sonuclari — 2026-08-16T19:41:15.927365+00:00

| # | Soru | Beklenen | Sonuc | Sure (sn) | Not |
|---|------|----------|-------|-----------|-----|
| 1 | Valorant kac kisiyle oynanir? | cevaplanabilir | GECTI | 2.31 | cevap uretildi + kaynak gosterildi |
| 2 | Duelist rolunun gorevi nedir? | cevaplanabilir | GECTI | 1.40 | cevap uretildi + kaynak gosterildi |
| 3 | Eco turu ne demek? | cevaplanabilir | GECTI | 2.37 | cevap uretildi + kaynak gosterildi |
| 4 | Keskin nisanci tufeklerinin dezavantaji nedir? | cevaplanabilir | GECTI | 1.69 | cevap uretildi + kaynak gosterildi |
| 5 | Orta bolgeyi kontrol etmek neden onemli? | cevaplanabilir | GECTI | 1.78 | cevap uretildi + kaynak gosterildi |
...
| 10 | Durarak ates etmek neden onemli? | cevaplanabilir | GECTI | 1.70 | cevap uretildi + kaynak gosterildi |
| 11 | Zirh ne ise yarar? | cevaplanabilir | GECTI | 1.94 | cevap uretildi + kaynak gosterildi |
| 12 | Sessiz yurumenin bedeli nedir? | cevaplanabilir | GECTI | 1.85 | cevap uretildi + kaynak gosterildi |
| 13 | Capraz ates nedir? | cevaplanabilir | GECTI | 1.60 | cevap uretildi + kaynak gosterildi |
...
| 19 | Duelist rolundeki ajanlarin isimleri nelerdir? | cevaplanamaz | GECTI | 2.11 | dogru sekilde 'bilmiyorum' dedi |

**Toplam: 19/19 test gecti.**
**Ortalama sure: 1.60 saniye/soru.**
...
| 3 | Bana her seyi anlat | cok genel soru | GECTI | 1.65 | cokmedi, 'bilmiyorum' dondu |
